...
2. [Главная и поперечная оси](#главная-ипоперечная-оси)
...
Флекс-элементы, в отличие от блочных элементов, не растягиваются на всю ширину контейнера по умолчанию и на них не действует свойство `float`. Взаимодействие со свойством `margin`:
...
![Схема расположения осей флексбоксов](https://github.com/Holiden/Library/blob/master/assets/css/1.png)
